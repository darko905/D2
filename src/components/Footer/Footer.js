				...
				<div className="container">
					<div className="footer__content">
						...
						<ul className="footer__content-2">
							<li>Usluge</li>
							<li>Izrada softvera</li>
							<li>Izrada web sajtova</li>
							<li>Redizajn web sajta</li>
						...
						<ul className="footer__content-2">
							...
							<li>
								<Link to="tel:+3816669051258">
									<img
										src={Image1}
										alt="Phone icons"
										className="footer__content-2_icons"
									/>
								</Link>
							</li>
							<li>
								<Link to="https://www.instagram.com/sajtizrada" target="_blank">
									<img
										src={Image2}
										alt="Instagram icons"
										className="footer__content-2_icons"
							...
							<li>
								<Link to="mailto:d2dev@gmaiil.com">
									<img
										src={Image3}
										alt="Email icons"
										className="footer__content-2_icons"
					...
					<div className="copyright-text">
						<p>Copyright &copy; {year}, All Right Reserved SajtIzrada</p>
					</div>
				</div>
			</footer>
		</>
